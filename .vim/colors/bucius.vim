...
if g:lucius_style == "dark"
    ...
    hi Normal       guifg=#f6f3e8   guibg=#303030   ctermfg=188    ctermbg=236       gui=none      cterm=none

    hi Comment      guifg=#efb1da   guibg=NONE      ctermfg=95     ctermbg=NONE      gui=italic      cterm=none
...
elseif g:lucius_style == "light"
    ...
    hi Normal       guifg=#000000   guibg=#eeeeee   ctermfg=237    ctermbg=255       gui=none      cterm=none

    hi Comment      guifg=#d24d9f   guibg=NONE      ctermfg=244    ctermbg=NONE      gui=none      cterm=none
